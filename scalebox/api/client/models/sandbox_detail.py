...
class SandboxDetail:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cpu_count = data.pop("cpu_count","")

        # end_at = isoparse(data.pop("endAt",""))

        memory_mb = data.pop("memory_mb","")

        sandbox_id = data.pop("sandbox_id","")

        started_at = isoparse(data.pop("created_at"))

        state = SandboxState(data.pop("status",""))
