...
class WatchDirRequest(_message.Message):
    ...
    recursive: bool
    def __init__(
        self, path: _Optional[str] = ..., recursive: _Optional[bool] = ...
    ) -> None: ...
...
class ExecuteResponse(_message.Message):
    ...
    def __init__(
        self,
        stdout: _Optional[_Union[Output, _Mapping]] = ...,
        stderr: _Optional[_Union[Output, _Mapping]] = ...,
...
class Result(_message.Message):
    ...
    def __init__(
        ...
        finished_at: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        text: _Optional[str] = ...,
        html: _Optional[str] = ...,
        markdown: _Optional[str] = ...,
        svg: _Optional[str] = ...,
        png: _Optional[str] = ...,
        jpeg: _Optional[str] = ...,
        pdf: _Optional[str] = ...,
        latex: _Optional[str] = ...,
        json: _Optional[str] = ...,
        javascript: _Optional[str] = ...,
        data: _Optional[str] = ...,
        chart: _Optional[_Union[Chart, _Mapping]] = ...,
        execution_count: _Optional[int] = ...,
        is_main_result: _Optional[bool] = ...,
...
class Chart(_message.Message):
    ...
    def __init__(
        ...
        type: _Optional[str] = ...,
        title: _Optional[str] = ...,
        elements: _Optional[_Iterable[_Union[ChartElement, _Mapping]]] = ...,
        extra: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
...
class ChartElement(_message.Message):
    ...
    def __init__(
        self,
        point_data: _Optional[_Union[PointData, _Mapping]] = ...,
        bar_data: _Optional[_Union[BarData, _Mapping]] = ...,
        pie_data: _Optional[_Union[PieData, _Mapping]] = ...,
        box_whisker_data: _Optional[_Union[BoxAndWhiskerData, _Mapping]] = ...,
        nested_chart: _Optional[_Union[Chart, _Mapping]] = ...,
    ) -> None: ...
...
class Point(_message.Message):
    ...
    def __init__(
        self,
        x_str: _Optional[str] = ...,
        x_num: _Optional[float] = ...,
        y_str: _Optional[str] = ...,
        y_num: _Optional[float] = ...,
    ) -> None: ...
...
class BoxAndWhiskerData(_message.Message):
    ...
    def __init__(
        ...
        label: _Optional[str] = ...,
        min: _Optional[float] = ...,
        first_quartile: _Optional[float] = ...,
        median: _Optional[float] = ...,
        third_quartile: _Optional[float] = ...,
        max: _Optional[float] = ...,
        outliers: _Optional[_Iterable[float]] = ...,
    ) -> None: ...
...
class Chart2D(_message.Message):
    ...
    def __init__(
        ...
        x_unit: _Optional[str] = ...,
        y_unit: _Optional[str] = ...,
        chart: _Optional[_Union[Chart, _Mapping]] = ...,
    ) -> None: ...
...
class PointChart(_message.Message):
    ...
    def __init__(
        self,
        x_ticks: _Optional[_Iterable[str]] = ...,
        x_tick_labels: _Optional[_Iterable[str]] = ...,
        x_scale: _Optional[str] = ...,
        y_ticks: _Optional[_Iterable[str]] = ...,
        y_tick_labels: _Optional[_Iterable[str]] = ...,
        y_scale: _Optional[str] = ...,
        chart_2d: _Optional[_Union[Chart2D, _Mapping]] = ...,
    ) -> None: ...
...
class CreateContextRequest(_message.Message):
    ...
    cwd: str
    def __init__(
        self, language: _Optional[str] = ..., cwd: _Optional[str] = ...
    ) -> None: ...
