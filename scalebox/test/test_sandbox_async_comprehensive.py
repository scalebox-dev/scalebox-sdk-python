...
class AsyncSandboxValidator:
    ...
    async def test_filesystem_rename(self):
        ...
        # 重命名
        result = await self.sandbox.files.rename("/workspace/tmp/old_name.txt", "/workspace/tmp/new_name.txt")
        print(result)
    ...
    async def test_command_run_with_error(self):
        ...
        try:
            ...
            assert "No such file or directory" in e.stdout or "cannot access" in e.stdout
    ...
    async def run_all_tests(self):
        ...
        await self.run_test(self.test_filesystem_write_multiple, "Filesystem Write Multiple")
        ...
        await self.run_test(self.test_command_with_env_and_cwd, "Command With Env And CWD")
        ...
        # 错误处理测试
        await self.run_test(self.test_error_handling_file_operations, "Error Handling File Operations")
        await self.run_test(self.test_error_handling_command_operations, "Error Handling Command Operations")
        
        # 性能测试
        await self.run_test(self.test_performance_file_operations, "Performance File Operations")
        await self.run_test(self.test_performance_command_operations, "Performance Command Operations")
