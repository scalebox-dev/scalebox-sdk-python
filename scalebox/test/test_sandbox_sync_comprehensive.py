...
class SandboxValidator:
    ...
    def test_filesystem_rename(self):
        ...
        # 重命名
        result = self.sandbox.files.rename("/workspace/tmp/old_name.txt", "/workspace/tmp/new_name.txt")
    ...
    def test_filesystem_watch_dir(self):
        ...
        try:
            ...
            logger.warning(f"Directory watching test failed (may not be supported): {e}")
    ...
    def run_all_tests(self):
        ...
        # 错误处理测试
        self.run_test(self.test_error_handling_file_operations, "Error Handling File Operations")
        self.run_test(self.test_error_handling_command_operations, "Error Handling Command Operations")
        
        # 性能测试
        self.run_test(self.test_performance_file_operations, "Performance File Operations")
        self.run_test(self.test_performance_command_operations, "Performance Command Operations")
        self.run_test(self.test_performance_concurrent_commands, "Performance Concurrent Commands")
